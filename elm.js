  ...
  function _Json_runHelp(decoder, value) {
    switch (decoder.$) {
      ...
      case 6:
        ...
        return ($elm$core$Result$isOk(result)) ? result : $elm$core$Result$Err(
...
type alias Process =
  ...
  */
  ...
  var _Browser_element = _Debugger_element ||
  ...
  var _Browser_document = _Debugger_document ||
    F4(function (impl, flagDecoder, debugMetadata, args) {
      return _Platform_initialize(
        flagDecoder,
        args,
  ...
  function _Browser_getUrl() {
    return $elm$url$Url$fromString(_VirtualDom_doc.location.href).a ||
      _Debug_crash(1);
  }
  ...
  var _Browser_doc = typeof document !== "undefined"
    ? document
    : _Browser_fakeNode;
  var _Browser_window = typeof window !== "undefined"
    ? window
    : _Browser_fakeNode;
  ...
  var $elm$url$Url$chompBeforePath = F5(
    function (protocol, path, params, frag, str) {
      if (
        $elm$core$String$isEmpty(str) || A2($elm$core$String$contains, "@", str)
      ) {
        return $elm$core$Maybe$Nothing;
      } else {
  ...
  var $author$project$Main$Sudah = 2;
  var $author$project$Main$readStatus = function (str) {
    switch (str) {
      case "sudah":
        return 2;
      case "sedang":
  ...
  var $author$project$Main$statusDecoder = A2(
    ...
    $author$project$Main$readStatus,
  ...
  var $author$project$Main$decoder = A5(
    $elm$json$Json$Decode$map4,
  ...
  var $author$project$Main$showStatus = function (status) {
    switch (status) {
      case 0:
        return "belum";
      case 1:
        ...
        [
          _Utils_Tuple2(
            ...
            A2(
              ...
              $author$project$Main$encodeTodo,
              model.o,
            ),
          ),
          _Utils_Tuple2(
        ...
        if (!_v0.b.b) {
          ...
          if ((!_v0.a.b.b) && (!_v0.b.b.b)) {
            ...
            return A2(
              $elm$core$List$cons,
              A2(fn, x, y),
              A3($author$project$Main$zipWith, fn, xx, yy),
            );
          }
        }
      }
  ...
  var $author$project$Main$normalizeTodos = function (todos) {
  ...
  var $author$project$Main$urutkanTodos = F2(
  ...
  var $author$project$Main$TambahTodo = F2(
    function (a, b) {
      return { $: 0, a: a, b: b };
    },
  );
  ...
  var $elm$html$Html$Attributes$placeholder =
    $elm$html$Html$Attributes$stringProperty("placeholder");
  var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
  var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
  var $elm$core$String$toFloat = _String_toFloat;
  var $elm$html$Html$Attributes$type_ =
    $elm$html$Html$Attributes$stringProperty("type");
  var $elm$html$Html$Attributes$value =
    $elm$html$Html$Attributes$stringProperty("value");
  ...
  var $author$project$Main$enumerateStatus = function (status) {
    switch (status) {
      case 0:
        return 0;
      case 1:
  ...
  var $elm$svg$Svg$trustedNode = _VirtualDom_nodeNS(
    "http://www.w3.org/2000/svg",
  );
  var $elm$svg$Svg$polygon = $elm$svg$Svg$trustedNode("polygon");
  var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute("stroke");
  var $elm$svg$Svg$Attributes$strokeLinecap = _VirtualDom_attribute(
    "stroke-linecap",
  );
  var $elm$svg$Svg$Attributes$strokeLinejoin = _VirtualDom_attribute(
    "stroke-linejoin",
  );
  var $elm$svg$Svg$Attributes$strokeWidth = _VirtualDom_attribute(
    "stroke-width",
  );
    ...
    _List_fromArray(
      [
        A2(
          ...
          _List_fromArray(
            [
              $1602$elm_feather$FeatherIcons$xmlns(
                "http://www.w3.org/2000/svg",
              ),
  ...
  var $elm$html$Html$Attributes$max = $elm$html$Html$Attributes$stringProperty(
    "max",
  );
      ...
      _List_fromArray(
        [
          $elm$html$Html$Attributes$class(
            "todo " + $author$project$Main$showStatus(todo.l),
          ),
        ],
      ),
      _List_fromArray(
                          ...
                          [
                            $elm$html$Html$Attributes$value(
                              $elm$core$String$fromInt(
                                $author$project$Main$enumerateStatus(todo.l),
                              ),
                            ),
                              ...
                              _List_fromArray(
                                [
                                  A2(
                                    $1602$elm_feather$FeatherIcons$toHtml,
                                    _List_Nil,
                                    $1602$elm_feather$FeatherIcons$trash,
                                  ),
        ...
        [
                  ...
                  _List_fromArray(
                    [
                        ...
                        _List_fromArray(
                          [
                            ...
                            $elm$html$Html$Events$onInput(
                              $author$project$Main$SimpanTeksInput,
                            ),
                          ],
                        ),
                        _List_Nil,
                      ...
                      A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Attributes$placeholder("prioritas"),
                            $elm$html$Html$Events$onInput(
                              A2(
          ...
          A2(
            ...
            _List_fromArray(
              [
                $elm$html$Html$text(
                  "Copyright (c) 2024 LitFill. All Rights Reserved.",
                ),
              ],
            ),
          ),
