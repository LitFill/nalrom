...
{
	if (region.Z.F === region.ad.F)
	{
		return 'on line ' + region.Z.F;
	}
	return 'on lines ' + region.Z.F + ' through ' + region.ad.F;
}
...
var $author$project$Todo$main = $elm$html$Html$text('Hello');
...
var $author$project$Todo$Todo = F5(
	function (id, deskripsi, status, prioritas, skala) {
		return {S: deskripsi, r: id, W: prioritas, Y: skala, u: status};
	});
var $author$project$Todo$L = 2;
var $author$project$Todo$M = 1;
var $author$project$Todo$S = 0;
var $author$project$Todo$XL = 3;
var $author$project$Todo$readSkala = function (str) {
	switch (str) {
		case 'S':
			return 0;
		case 'M':
...
var $author$project$Main$skalaDecoder = A2($elm$json$Json$Decode$map, $author$project$Todo$readSkala, $elm$json$Json$Decode$string);
var $author$project$Todo$Belum = 0;
var $author$project$Todo$Sedang = 1;
var $author$project$Todo$Sudah = 2;
var $author$project$Todo$readStatus = function (str) {
	switch (str) {
		case 'sudah':
			return 2;
		case 'sedang':
...
var $author$project$Main$statusDecoder = A2($elm$json$Json$Decode$map, $author$project$Todo$readStatus, $elm$json$Json$Decode$string);
var $author$project$Main$todoDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Todo$Todo,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'deskripsi', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'status', $author$project$Main$statusDecoder),
	A2($elm$json$Json$Decode$field, 'prioritas', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'skala', $author$project$Main$skalaDecoder));
var $author$project$Main$decoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$Model,
	A2(
		$elm$json$Json$Decode$field,
		'todos',
		$elm$json$Json$Decode$list($author$project$Main$todoDecoder)),
	A2($elm$json$Json$Decode$field, 'id_berikutnya', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'teks_input', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'prioritas_input', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'skala_input', $elm$json$Json$Decode$string));
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (flag) {
	return _Utils_Tuple2(
		function () {
			var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decoder, flag);
			if (!_v0.$) {
				var model = _v0.a;
				return model;
			} else {
...
var $author$project$Todo$showSkala = function (skala) {
	switch (skala) {
		case 0:
			return 'S';
		case 1:
...
var $author$project$Todo$showStatus = function (status) {
	switch (status) {
		case 0:
			return 'belum';
		case 1:
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(todo.r)),
				_Utils_Tuple2(
				'deskripsi',
				$elm$json$Json$Encode$string(todo.S)),
				_Utils_Tuple2(
				'status',
				...
				_Utils_Tuple2(
				'prioritas',
				$elm$json$Json$Encode$float(todo.W)),
				_Utils_Tuple2(
				'skala',
				$elm$json$Json$Encode$string(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'prioritas_input',
				$elm$json$Json$Encode$float(model.G)),
				_Utils_Tuple2(
				'skala_input',
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var prioritas = msg.b;
				var skala = msg.c;
				var todoBaru = {S: desk, r: model.B, W: prioritas, Y: skala, u: 0};
				return _Utils_Tuple2(
								...
								$elm$core$List$reverse(
									$author$project$Todo$normalize(
										A2(
											$elm$core$List$map,
											function (todo) {
												return _Utils_eq(todo.r, id) ? _Utils_update(
													todo,
													{u: status}) : todo;
											},
											model.l))))
...
var $author$project$Main$updateDanStorage = F2(
	function (msg, modelLama) {
		var _v0 = A2($author$project$Main$update, msg, modelLama);
		var modelBaru = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			modelBaru,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$encode(modelBaru)),
						cmd
					])));
	});
...
var $author$project$Main$SimpanSkalaInput = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$SimpanTeksInput = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$TambahTodo = F3(
	function (a, b, c) {
...
var $author$project$Main$onSelect = function (tagger) {
	return A2(
		$elm$html$Html$Events$stopPropagationOn,
		'input',
		A2(
...
var $author$project$Main$HapusTodo = function (a) {
	return {$: 5, a: a};
};
...
var $1602$elm_feather$FeatherIcons$toHtml = F2(
	function (attributes, _v0) {
		var src = _v0.h;
		var attrs = _v0.f;
		var strSize = $elm$core$String$fromFloat(attrs.P);
		var baseAttributes = _List_fromArray(
			[
				$elm$svg$Svg$Attributes$fill('none'),
				$elm$svg$Svg$Attributes$height(
				_Utils_ap(strSize, attrs.H)),
				...
				$elm$core$String$fromFloat(attrs.Q)),
				$elm$svg$Svg$Attributes$viewBox(attrs.R)
			]);
...
var $author$project$Main$viewTodo = function (todo) {
	var _v0 = function () {
		...
		switch (_v1) {
			case 0:
				return _Utils_Tuple2(
					A2($author$project$Main$GantiStatusTodo, todo.r, 1),
					' lakukan');
			case 1:
				return _Utils_Tuple2(
					A2($author$project$Main$GantiStatusTodo, todo.r, 2),
					' selesai');
			default:
				return _Utils_Tuple2(
					A2($author$project$Main$GantiStatusTodo, todo.r, 0),
					' ulangi');
		}
	}();
	var msg = _v0.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'todo ' + $author$project$Todo$showStatus(todo.u))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('teks')
							]),
						_List_fromArray(
							[
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Main$HapusTodo(todo.r))
											]),
										_List_fromArray(
											[
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($author$project$Main$TambahTodo, model.K, model.G, skala))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('todo baru'),
										$elm$html$Html$Events$onInput($author$project$Main$SimpanTeksInput)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('prioritas (0.0 - ∞)'),
										...
										A2(
											...
											A2(
												...
												$author$project$Main$SimpanPrioritasInput)))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$name('skala'),
										$elm$html$Html$Events$onInput($author$project$Main$SimpanSkalaInput),
										$author$project$Main$onSelect($author$project$Main$SimpanSkalaInput)
									]),
								_List_fromArray(
									[
										A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Copyright (c) 2024 '),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/LitFill')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('LitFill')
							])),
						$elm$html$Html$text('. All Rights are open source.')
					]))
			]));
};
